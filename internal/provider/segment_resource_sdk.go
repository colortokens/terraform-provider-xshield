...
func (r *SegmentResourceModel) RefreshFromSharedTagBasedPolicyResponse(resp *shared.TagBasedPolicyResponse) {
	if resp != nil {
		...
		r.InboundAutoSyncDeploymentMode = normalizeAutoSyncDeploymentMode(resp.InboundAutoSyncDeploymentMode)
		r.InboundAutoSyncIntervalMinutes = autoSyncSentinelToNull(resp.InboundAutoSyncIntervalMinutes)
		r.InboundAutoSyncIncludeViolations = types.BoolPointerValue(resp.InboundAutoSyncIncludeViolations)
		r.InboundAutoSyncViolationThreshold = autoSyncSentinelToNull(resp.InboundAutoSyncViolationThreshold)
		r.OutboundAutoSyncDeploymentMode = normalizeAutoSyncDeploymentMode(resp.OutboundAutoSyncDeploymentMode)
		r.OutboundAutoSyncIntervalMinutes = autoSyncSentinelToNull(resp.OutboundAutoSyncIntervalMinutes)
		r.OutboundAutoSyncIncludeViolations = types.BoolPointerValue(resp.OutboundAutoSyncIncludeViolations)
		r.OutboundAutoSyncViolationThreshold = autoSyncSentinelToNull(resp.OutboundAutoSyncViolationThreshold)
