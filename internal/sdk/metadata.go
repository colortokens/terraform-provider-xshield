...
func (s *Metadata) ListFields(ctx context.Context, request operations.ListFieldsRequest, opts ...operations.Option) (*operations.ListFieldsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.MetadataResponse
...
// SummarizeField - returns facet for a field in context of criteria.
// Returns facet for selected field.
func (s *Metadata) SummarizeField(ctx context.Context, request shared.SummarizeField, opts ...operations.Option) (*operations.SummarizeFieldResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/api/fields/actions/summarize")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.SummarizeFieldResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SummarizeFieldResults
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SummarizeFieldResults = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
